...
<section class="py-16 px-4 md:px-8 lg:px-16 xl:px-24">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <?php
            $args = array(
                'post_type'      => 'promoactions', // Изменяем на 'promoactions'
            ...
            if ($promoactions_query->have_posts()) :
                    ...
                    <div class="condition-item flex flex-col items-center text-center">
                        ...
                        <!-- Кнопка для участия -->
                         <div class="flex gap-4 items-center">
                            <button class="mt-4 bg-[#FF4A1D] hover:bg-[#F35726] text-white px-4 py-2 rounded-md font-bold flex gap-2">
                                <a href="<?php the_permalink(); ?>" class="flex gap-2"> Участвовать <span class="ml-2"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/pepicons-print_arrow-left.svg" alt="circles" class="w-6"></span></a>
                            </button>
                ...
                <div class="remodal" data-remodal-id="conditions-<?php echo get_the_ID(); ?>" role="dialog" aria-labelledby="modalTitle" aria-describedby="modalDesc">
                    <button data-remodal-action="close" class="remodal-close"></button>
                    <h2 id="modalTitle" class="text-xl font-bold mb-4">Условия акции</h2>
                    <div class="modal-content">
                        <?php
                        // Получаем описание условий акции из мета-поля или контента
                        $conditions = get_post_meta(get_the_ID(), 'promo_conditions', true);
                        if ($conditions) {
                            echo wpautop($conditions); // Выводим условия акции
                        } else {
                            echo '<p>Условия не указаны.</p>';
                        }
                        ?>
                    </div>
