    ...
    <div class="relative z-10">
        ...
        <section class="relative flex justify-center items-center py-24 pt-48">
            <div class="w-full flex items-center justify-center flex-col text-center">
                ...
                <div class="mt-10">
                    <button id="submit-login" data-remodal-target="modal-auth" class="bg-[#FF4A1D] hover:bg-[#FF6B3D] text-white font-semibold text-lg px-8 py-2 rounded-lg transition-all duration-300 items-center flex max-w-[225px] justify-center">
