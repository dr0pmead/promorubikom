    ...
    <div class="flex flex-col items-center justify-center h-full text-white text-lg space-y-4">
        ...
        <div class="auth-modal bg-[#131313] border-[1px] border-[#fff]/10 p-8 rounded-lg text-center max-w-md mx-auto remodal" data-remodal-id="modal-auth" role="dialog" aria-labelledby="modalTitle" aria-describedby="modalDesc">
            ...
            <form id="login-form">
                ...
                <!-- Кнопка входа -->
                <button id="submit-login" class="bg-[#E53F0B] hover:bg-[#F35726] text-white px-6 py-3 rounded-md transition-colors font-bold font-xl w-full flex items-center justify-center">
...
<div class="auth-modal bg-[#131313] border-[1px] border-[#fff]/10 p-8 rounded-lg text-center max-w-md mx-auto remodal" data-remodal-id="modal-register" role="dialog" aria-labelledby="modalTitle" aria-describedby="modalDesc">
    ...
    <form id="registration-form" method="POST">
        ...
        <!-- Кнопка регистрации -->
        <button type="submit" id="submit-registration" class="bg-[#E53F0B] hover:bg-[#F35726] text-white px-6 py-3 rounded-md w-full transition-colors font-bold flex items-center justify-center">
...
<!-- Окно показа пароля -->
        ...
        <form id="change-password-form">
            ...
            <!-- Кнопка для отправки -->
            <button type="submit" id="submit-password" class="bg-[#E53F0B] hover:bg-[#F35726] mt-6 text-white px-6 py-3 rounded-md w-full transition-colors font-bold flex items-center justify-center">
...
jQuery(document).ready(function($) {
    $('#change-password-form').on('submit', function(e) {
        ...
        $.ajax({
            url: ajax_object.ajax_url, // admin-ajax.php для WordPress
            type: 'POST',
            data: {
